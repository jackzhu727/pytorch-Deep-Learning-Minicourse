...
$$ P(y \mid x) = \frac{\int_z e^{-\beta E(x,y,z)}}{\int_y\int_z e^{-\beta E(x,y,z)}} = \frac{e^{-\beta \left [-\frac{1}{\beta}\log \int_z e^{-\beta E(x,y,z)}\right ] }}{\int_y e^{-\beta\left [-\frac{1}{\beta}\log \int_z e^{-\beta E(x,y,z)}\right ]}} = \frac{e^{-\beta F_{\beta}(x,y)}}{\int_y e^{-\beta F_{\beta} (x,y)}}$$
